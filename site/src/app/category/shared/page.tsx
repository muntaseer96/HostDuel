...
export default async function SharedHostingCategory() {
  ...
  const hosts = allHosts
    .filter((host) => host.hostingType === 'shared')
    ...
    <section className="py-16">
      <Container>
        <div className="mb-12">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-4">Shared Hosting</h1>
          <p className="text-lg text-text-secondary max-w-2xl">
            Shared hosting is the most affordable option for beginners and small websites.
            Multiple sites share server resources, keeping costs low while providing
        ...
        {hosts.length === 0 && (
          <div className="text-center py-12">
            <p className="text-text-muted">No shared hosting providers found.</p>
          </div>
        )}
